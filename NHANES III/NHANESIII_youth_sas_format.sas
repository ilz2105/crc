    ...
    *** LRECL includes 2 positions for CRLF, assuming use of PC SAS;
    ...
    DATA youth_nhanesIII;
      INFILE '/home/ilz21050/crc/NHANESIII_youth.dat';
...
data youth_nhanesIII;
set youth_nhanesIII; 
keep  SEQN  DMARETHN;  *"Race-ethnicity";
keep DMARACER;  *"Race";
 keep       DMAETHNR; *"Ethnicity";
  keep      HSSEX;    *"Sex";
 rename DMARETHN = race_ethnicity DMARACER = race DMAETHNR = ethnicity HSSEX = sex
 HFF1 = anyone_smoke_at_home HFF2R = num_ppl_smoke_home;       
run;
