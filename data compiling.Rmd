...
diet_interview_1999_2000 = read.xport("./1999-2000/DRXIFF.XPT") %>% 
   janitor::clean_names() %>%
  select(drxiprot, drxitfat, drxisfat, drxipfat, drxichol)
#cant find sugar variable
...
med_condit_99_00 = read.xport("./1999-2000/MCQ.XPT") %>% 
  ...
  select(seqn, chd, heart_attack,stroke, thyroid_prob, liver_cond, ever_cancer )
```
...
diet_interview_01_02 = read.xport("./2001-2002/DRXIFF_B.XPT") %>% 
   janitor::clean_names() %>% 
  mutate() %>% 
  select(drxiprot, drxisugr, drxitfat, drxisfat, drximfat, drxipfat, drxichol)
...
demo_bp_chol = merge(demo_med, bp_chol, by = "seqn")
```
